...
ax_ideal.imshow(ideal_pattern[crop_idn:-crop_idn, crop_idn:-crop_idn], cmap=cmap, aspect='equal')
ax_ideal.axis('off')
...
ax_defocus.imshow(defocus_pattern[crop_idn:-crop_idn, crop_idn:-crop_idn], cmap=cmap, aspect='equal')
ax_defocus.axis('off')
...
oap0.imshow(oap_pattern_0[crop_idn:-crop_idn, crop_idn:-crop_idn], cmap=cmap, aspect='equal')
oap0.axis('off')

rot_angle = 45
oap_pattern_45 = shear_plate(Rc=1.e10, atype='oap', wfe=wf_error, wfe_phi=rot_angle)
oap45.imshow(oap_pattern_45[crop_idn:-crop_idn, crop_idn:-crop_idn], cmap=cmap, aspect='equal')
oap45.axis('off')

# oap case
rot_angle = 90
oap_pattern_90 = shear_plate(Rc=1.e10, atype='oap', wfe=wf_error, wfe_phi=rot_angle)
oap90.imshow(oap_pattern_90[crop_idn:-crop_idn, crop_idn:-crop_idn], cmap=cmap, aspect='equal')
oap90.axis('off')
...
ax_sphere.imshow(sphere_pattern[crop_idn:-crop_idn, crop_idn:-crop_idn], cmap=cmap, aspect='equal')
ax_sphere.axis('off')
...
ax_coma.imshow(coma_pattern[crop_idn:-crop_idn, crop_idn:-crop_idn], cmap=cmap, aspect='equal')
ax_coma.axis('off')
