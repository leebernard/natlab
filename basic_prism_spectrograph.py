...
# current design has F1=2 inch collimator, and F2=6 inch camera mirror
#   telescope has F-number, Fn=11
F1,F2,Fn=2*2.54*1.e-2,6*2.54*1.e-2,11.
...
# convert fwhm from arcsec to um
fwhm_um = fwhm/theta_pixel*ps*1e6
...
wavelength = 630e-6
input_dia = 1.5
spot_dia = 1.27*wavelength*fl/input_dia
pinhole = spot_dia*1.5
print('pinhole size:', pinhole)
